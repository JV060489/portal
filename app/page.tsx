            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="max-w-2xl text-base leading-7 text-neutral-400 sm:text-lg">
                  Shape environments, iterate on ideas, and move from prompt to
                  scene inside a workspace designed for modern 3D creation.
                </p>
              </motion.div>
              ...
              >
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="rounded-full border-neutral-700 bg-neutral-900 px-8 hover:bg-neutral-800"
                >
                  ...
                  <LivingCard
                    ...
                    overlay={
                      <div className="flex flex-col items-center justify-center h-full">
                        <p className="text-sm uppercase tracking-[0.3em] text-gray-400 text-center">
                          {card.title}
                        </p>
